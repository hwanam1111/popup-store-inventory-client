...
DOCKER_APP_NAME=createjump-inventory-frontend-server
...
echo "> Start health check of Create Jump Inventory Front Server at 'http://127.0.0.1:${TARGET_PORT}'..."
...
do
    ...
    if [ ${RESPONSE_CODE} -eq 200 ]; then
        echo "> New Create Jump Inventory Front Server successfully running" 
        echo "> Close Old Create Jump Inventory Front Server"
